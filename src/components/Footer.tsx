            ...
            <div className="flex flex-col md:flex-row justify-between items-center p-5 text-white mx-6 gap-y-5 md">
                ...
                <div>
                    <ul className="flex flex-col md:flex-row justify-center items-center gap-x-5 font-semibold mb-3">
                        <Link href="/">
                            <li className="hover:text-[#E28B00] duration-100">Início</li></Link> <hr className="md:w-px h-3 md:h-6 bg-white border-none " />
                        
                        <Link href="/on">
                            <li className="hover:text-[#E28B00] duration-100">Sobre Nós</li></Link> <hr className="md:w-px h-3 md:h-6 bg-white border-none " />
                        
                        <Link href="/services"><li className="hover:text-[#E28B00] duration-100">Serviços</li></Link> <hr className="md:w-px h-3 md:h-6 bg-white border-none " />
                        <Link href="/companies"><li className="hover:text-[#E28B00] duration-100">Abrir Empresa</li></Link> <hr className="md:w-px h-3 md:h-6 bg-white border-none " />
                        <Link href="/contact"><li className="hover:text-[#E28B00] duration-100">Contato</li></Link>
                    </ul>
                </div>
            </div>
